...
export function Card({ title, children, href }: { title: string; children: ReactNode; href: string }): JSX.Element {
  return (
    <a
      className="ui-rounded-lg ui-border ui-border-transparent ui-px-5 ui-py-4 ui-transition-colors hover:ui-border-neutral-700 hover:ui-bg-neutral-800/30 ui-group "
